...
public class Complex {
    ...
    public Complex conjugate() {
    	...
    	conj.setReal(getReal());
    	conj.setImag(-getImag());
    	return conj;
    }
    ...
    public Complex add(Complex b) {
    	...
    	add.setReal(getReal() + b.getReal());
    	add.setImag(getImag() + b.getImag());
    	return add;
    }
    ...
    public Complex multiply(double alpha) {
    	...
    	k.setReal(getReal() * alpha);
    	k.setImag(getImag() * alpha);
    	return k;
    }
    ...
    public Complex multiply(Complex b) {
    	...
    	mult.setReal((getReal() * b.getReal()) - (getImag() * b.getImag()));
    	mult.setImag((getReal() * b.getImag()) + (getImag() * b.getReal()));
    	return mult;
    }
