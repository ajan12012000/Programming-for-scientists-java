...
public class Complex {
    ...
    public String toString() {
        ...
        if (getImag() < 0.0)
            return getReal() + "-" + Math.abs(getImag()) + "i";
        else
            return getReal() + "+" + Math.abs(getImag()) + "i";
    }
    ...
    public Complex add(Complex b) {
    	...
    	add.setReal(this.getReal() + b.getReal());
    	add.setImag(this.getImag() + b.getImag());
    	return add;
    }
    ...
    public Complex minus() {
    	...
    	neg.setReal(-this.getReal());
    	neg.setImag(-this.getImag());
    	return neg;
    }
    ...
    public Complex multiply(double alpha) {
    	...
    	k.setReal(this.getReal() * alpha);
    	k.setImag(this.getImag() * alpha);
    	return k;
    }
    ...
    public Complex multiply(Complex b) {
    	...
    	mult.setReal((this.getReal() * b.getReal()) - (this.getImag() * b.getImag()));
    	mult.setImag((this.getReal() * b.getImag()) + (this.getImag() * b.getReal()));
    	return mult;
    }
    ...
    public Complex divide(Complex b) {
    	...
    	div.setReal((multiply(b.conjugate())).getReal()/b.abs2());
    	div.setImag((multiply(b.conjugate())).getImag()/b.abs2());
    	return div;
    }
